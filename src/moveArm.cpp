...
bool MoveArm::initialize(ur_rtde::RTDEReceiveInterface &reciver, ur_rtde::RTDEControlInterface& controller){
...
std::vector<double> MoveArm::getToPoseEstimation(ur_rtde::RTDEReceiveInterface &reciver, ur_rtde::RTDEControlInterface &controller, int type, cv::Vec6d position, double velocity, double acceleration){
    std::cout << "Moving to checker postion" << std::endl;
    ur_rtde::RTDEReceiveInterface receiverNew("192.168.100.50");
    std::vector<double> baseFrame = receiverNew.getTargetTCPPose();
    std::cout << "Move frame: " << readVector(baseFrame) << std::endl;
    std::this_thread::sleep_for(std::chrono::milliseconds(100));
//    std::vector<double> featureFrame = {position[0],position[1],position[2],baseFrame[3],baseFrame[4],position[5]};
//    std::vector<double> featureFrame2 = {0,0,0,0,0,position[5]};
//    std::vector<double> moveFrame = controller.poseTrans(baseFrame,featureFrame2);
//    //std::cout << "Move frame: " << readVector(moveFrame) << std::endl;
...
//            std::vector<double> change_9_1 = {0.025,0.10,0.0,0.26,-0.087,0.0};
...
//            std::vector<double> change_9_4 = {-0.025,-0.10,0.0,-0.26,0.087,0.0};
...
//            std::vector<double> change_2_1 = {0.05,0.10,0.0,0.26,-0.175,0.0};
...
//            std::vector<double> change_2_4 = {-0.05,-0.10,0.0,-0.26,0.175,0.0};
...
//            std::vector<double> change_10_1 = {0.075,0.10,0.0,0.26,-0.26,0.0}; // Change to -0.26 from -0.13
...
//            std::vector<double> change_10_4 = {-0.075,-0.10,0.0,-0.26,0.26,0.0}; // Change to 0.26 from 0.13
...
//            std::vector<double> change_7_1 = {0.10,0.10,0.0,0.26,-0.26,0.0};
...
//            std::vector<double> change_7_4 = {-0.10,-0.10,0.0,-0.26,0.26,0.0};
...
//            std::vector<double> change_3_1 = {0.10,0.05,0.0,0.175,-0.26,0.0};
...
//            std::vector<double> change_3_4 = {-0.10,-0.05,0.0,-0.175,0.26,0.0};
...
//            std::vector<double> change_12_1 = {0.10,0.025,0.0,0.087,-0.26,0.0};
...
//            std::vector<double> change_12_4 = {-0.10,-0.025,0.0,-0.087,0.26,0.0};
...
//            std::vector<double> change_14_1 = {0.10,-0.075,0.0,-0.175,-0.175,0.0};
...
//            std::vector<double> change_14_4 = {-0.10,0.075,0.0,0.175,0.175,0.0};
...
//            std::vector<double> change_8_1 = {0.10,-0.10,0.0,-0.26,-0.26,0.0};
...
//            std::vector<double> change_8_4 = {-0.10,0.10,0.0,0.26,0.26,0.0};
...
//            std::vector<double> change_15_1 = {0.075,-0.10,0.0,-0.26,-0.26,0.0};
...
//            std::vector<double> change_15_4 = {-0.075,0.10,0.0,0.26,0.26,0.0};
...
//            std::vector<double> change_6_1 = {0.05,-0.10,0.0,-0.26,-0.175,0.0};
...
//            std::vector<double> change_6_4 = {-0.05,0.10,0.0,0.26,0.175,0.0};
...
//            std::vector<double> change_16_1 = {0.025,-0.10,0.0,-0.26,-0.087,0.0};
...
//            std::vector<double> change_16_4 = {-0.025,0.10,0.0,0.26,0.087,0.0};
...
void MoveArm::writeFileRobotTCPPoses(bool flagChoice, std::vector<std::vector<double>> robotPoses){
    if (flagChoice) {
        std::ofstream myfile;
