...
{
public:
    CameraCalibration( CameraSettings& cameraSettings, int verticalIntersections = 9, int horizontalIntersections = 12,
                                                       int squareSize = 15, int numberOfCalibrationImages = 25);
